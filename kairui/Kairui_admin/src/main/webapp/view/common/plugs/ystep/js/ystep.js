    ...
    loadStep: function(params){
      ...
      $(this).each(function(i,n){
        ...
        for(i=0;i<arrayLength;i++){
          ...
          //构造步骤html
		  if(typeof(_s.isSubmitted) == "boolean"){
			  if(_s.isSubmitted){
				  $stepHtml.attr("class", "ystep-step ystep-step-done"); 
			  }else{
				  $stepHtml.attr("class", "ystep-step ystep-step-active"); 
			  }
		  }
		  if(typeof(_s.isSubmitted) == "undefined"){
			  $stepHtml.attr("class", "ystep-step ystep-step-undone"); 
		  }
