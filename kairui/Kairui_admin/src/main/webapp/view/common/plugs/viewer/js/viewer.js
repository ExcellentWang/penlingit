...
(function (global, factory) {
  ...
  Viewer.prototype = {
    ...
    view: function (index) {
      ...
      if (!_this.isShown || index < 0 || index >= _this.length ||
    ...
    prev: function () {
	  ...
	  if( _this.isPlayed){_this.prePlaying(); }
    ...
    next: function () {
	  ...
	  if( _this.isPlayed){_this.nextPlaying(); }
    ...
    play: function () {
	  ...
	  // 新增加播放时手动去滚动功能
	  _this.nextPlaying = function() {  
		  if(index == total-1){
			  tip({content: "已经是最后一张了！"});
			  return;
		  }
  ...
  Viewer.TEMPLATE = (
    '<div class="viewer-container">' +
	  ...
	  '<div style="position: absolute; left: 30px; top: 45%; cursor: pointer; "><img src="../../../images/prev.png"  data-action="prev" /></div>' + 
	  '<div style="position: absolute; right: 30px; top: 45%; cursor: pointer;"><img src="../../../images/next.png"  data-action="next" /></div>' + 
    '</div>'
  );
