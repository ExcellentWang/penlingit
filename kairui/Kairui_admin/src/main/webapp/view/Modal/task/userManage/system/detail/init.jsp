          ...
          <div class="ibox-content">
			...
			<input type="hidden" id="dictId" name="dictId" value="${dictId}">
              <div class="form-group form-group-sm">
                <div class="input-tip">
                  <label class="col-xs-3 col-sm-3 col-md-3 control-label">字段名称：</label>
                  <div class="col-xs-5 col-sm-5 col-md-5">
                    <input type="text" id="detailName" name="detailName" placeholder="" class="form-control">
                  </div>
                </div>
...
$(function() {
	$('#grid').datagrid({   
	    url:'${ctx}/system/detail/list?dictId=${dictId}', 
	    pageSize :10,
...
function showDetailAdd(){
	$.dialog.open(ctx+'/system/detail/showAdd?dictId=+${dictId}', {
		lock: true,
		width:600,
		height:230
	});
